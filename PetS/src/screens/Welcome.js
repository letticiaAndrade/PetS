    ...
    return (
        ...
        >
            <View style={{ width: sizeScreen }}>
                ...
                <View style={{ height: 84, width: sizeScreen, paddingRight: 20, marginTop: 80, alignItems: 'flex-end', borderWidth: 2 }}>
                    <FontAwesome.Button
                        name="chevron-right"
                        color="#B67830"
                        borderRadius={20}
            ...
            <View style={{ width: sizeScreen }}>
                ...
                <View style={{ alignItems: "flex-start", marginLeft: 80, marginBottom: 20 }}>
                    <Image
                ...
                <View style={{ height: 84, width: sizeScreen, paddingRight: 20, marginTop: 40, alignItems: 'flex-end', borderWidth: 2 }}>
                    <FontAwesome.Button
                        name="chevron-right"
                        color="#B67830"
                        borderRadius={20}
            ...
            <View style={{ width: sizeScreen }}>
                ...
                <View style={{ justifyContent: "center" }}>
                    <Text style={{ paddingLeft: 70, color: "#00D5B0", fontSize: 34, marginBottom: 10 }}>
                        ADOTE
                    </Text>
                    <Text style={{ alignSelf: 'center', color: "#EAEAEA", fontSize: 34 }}>
                        Amor de verdade é encontrado e não comprado!
                    </Text>
                </View>

                <View style={{ height: 84, width: sizeScreen, paddingRight: 20, marginTop: 30, alignItems: 'flex-end', borderWidth: 2 }}>
                    <FontAwesome.Button
                        name="chevron-right"
                        color="#B67830"
                        borderRadius={20}
            ...
            <View style={{ width: sizeScreen }}>
                ...
                <View style={{ height: 84, width: sizeScreen, paddingRight: 20, paddingTop: 30, alignItems: 'flex-end', borderWidth: 2 }}>
                    <FontAwesome.Button
                        name="chevron-right"
                        color="#B67830"
                        borderRadius={20}
