...
export const Profile = () => {
    return (
        <View style={{ flex: 1, backgroundColor: '#FFEDCB' }}>
            ...
            <View>
                <Text style={{ padding: 15, opacity: 0.5, color: "#342E29", fontSize: 16 }}>Conta</Text>
            </View>

            <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-around' }} activeOpacity={0.5} onPress={''}>
