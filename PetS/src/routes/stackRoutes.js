...
import { SignUp, SignIn, Welcome, Profile, Home, LostPets, MyPosts, MyLostPets, EditProfile, PostPet, PostLostPet, CardAnimal } from "../screens";
...
export const Routes = () => {
    return (
        ...
        >
            ...
            <Stack.Screen name="CardAnimal" component={CardAnimal} />
